...
ledcWrite(7, 470);
 ...
 while(1)
  ...
  u8g2.clearBuffer();u8g2.setCursor(0, 20); u8g2.print("ready");u8g2.sendBuffer(); 
while(1)
  {
    receivenow();
    if(stepx>=5){btsend(9);break;}
  }
...
while(1)
  ...
  //关门状态，红灯，开始响应手势，变绿灯后开门，btsend(25)这一句放在最后
   doorclose();
...
void doorclose()
{
  Serial.print("ncameramode ");Serial.print(ncameramode);
    ...
    for (int i=80;i<360;i++){ledcWrite(47, i);delay(4);}//不确定
    delay(250);
